    ...
    <section ref={containerRef} className="bg-background min-h-screen relative text-foreground selection:bg-accent selection:text-white font-sans">
      ...
      <div className="max-w-7xl mx-auto py-32 px-6 md:px-12">
        ...
        <div className="gallery-header max-w-3xl mb-24">
          <h1 className="text-[11px] font-bold text-stone-400 uppercase tracking-[0.5em] mb-6 block font-sans">Visual Record</h1>
          <h2 className="text-zinc-900 text-3xl md:text-6xl font-normal tracking-wide font-cursive">
            The Gowtham 's <span className="text-accent-2">Gallery</span>
          </h2>
        </div>
